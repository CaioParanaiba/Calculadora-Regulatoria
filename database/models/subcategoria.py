...
class SubCategoria(BaseModel):
    ...
    preco_variavel = FloatField()  # float
...
valores_iniciais = [
        {
            ...
            "formula": "n_funcionarios * horas_dedicas * custo_mao_obra",
            "preco_variavel": 0,
        ...
        },
        {
            ...
            "formula": "valor_taxa * n_interacoes",
            "preco_variavel": 0,
            "quantidades_json": '{"n_interacoes": 0}'
        },
        {
            "categoria": "Custos de Conformidade",
        ...
        },
        {
            ...
            "formula": "custo_capital * n_interacoes",
            "preco_variavel": 0,
            "quantidades_json": '{"n_interacoes": 0}'
        },
        {
            ...
            "formula": "custo_compra * n_compras",
            "preco_variavel": 0,
        ...
        },
        {
            ...
            "formula": "valor_imposto * n_interacoes",
            "preco_variavel": 0,
            "quantidades_json": '{"n_interacoes": 0}'
        },
        {
            ...
            "formula": "valor_tarifa * n_interacoes",
            "preco_variavel": 0,
            "quantidades_json": '{"n_interacoes": 0}'
        },
        {
            ...
            "formula": "valor_emolumentos * n_interacoes",
            "preco_variavel": 0,
            "quantidades_json": '{"n_interacoes": 0}'
        },
        {
            ...
            "formula": "valor_outorgas * n_interacoes",
            "preco_variavel": 0,
            "quantidades_json": '{"n_interacoes": 0}'
        }
        ]